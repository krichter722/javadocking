#!/bin/bash
#-----------------------------------------------------------------------
# WorspaceExample Startup Script
#-----------------------------------------------------------------------
...
MAIN_CLASS="com.javadocking.mainexample.MainExample"

# The base classpath
CLASSPATH=".:javadocking.jar:samples.jar:lib/tinylaf.jar:lib/liquidlnf.jar:lib/nimrodlf.jar:lib/substance-lite.jar:lib/jfreechart.jar:lib/jcommon.jar"
