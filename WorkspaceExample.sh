...
MAIN_CLASS="com.javadocking.workspaceexample.WorkspaceExample"

# The base classpath
CLASSPATH=".:javadocking.jar:samples.jar:lib/tinylaf.jar:lib/liquidlnf.jar:lib/nimrodlf.jar:lib/substance-lite.jar"
